...
if &background == 'dark'
  ...
  hi Comment guifg=#a6e3a1 guibg=NONE guisp=NONE gui=italic
  ...
  if has('gui_running')
    ...
    if s:extra_italic == 1
      hi gitcommitComment guifg=#a6e3a1 guibg=NONE guisp=NONE gui=NONE
      hi htmlSpecialTagName guifg=#268bd2 guibg=NONE guisp=NONE gui=NONE
      hi pandocComment guifg=#a6e3a1 guibg=NONE guisp=NONE gui=NONE
    ...
    elseif s:extra_italic == 3
      hi gitcommitComment guifg=#a6e3a1 guibg=NONE guisp=NONE gui=italic
      hi htmlSpecialTagName guifg=#268bd2 guibg=NONE guisp=NONE gui=italic
      hi pandocComment guifg=#a6e3a1 guibg=NONE guisp=NONE gui=italic
